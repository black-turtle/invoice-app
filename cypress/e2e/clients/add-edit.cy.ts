...
describe('/clients/new access', () => {
    CyCantAccessPageWithoutLogin('http://localhost:3000/clients/new')

    CyCantAccessPageWithoutCompanyDetails('http://localhost:3000/clients/new')
})
...
describe('/clients/*', () => {
    ...
    it('shows common errors in form', () => {
        ...
        cy.get(`[data-test="client-company-address-error"]`).should(
            'be.visible',
        )
        ...
        cy.get(`[data-test="client-email"]`).type(
        ...
        cy.get(`[data-test="client-company-vat-error"]`).should(
            'have.length',
            0,
        )
        cy.get(`[data-test="client-company-reg-error"]`).should('be.visible')
    ...
    it('creates new client', () => {
        ...
        // NEW_CLIENT_DETAILS
        cy.get(`[data-test="client-email"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.email)
        cy.get(`[data-test="client-name"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.name)
        cy.get(`[data-test="client-company-name"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.companyName)
        cy.get(`[data-test="client-company-address"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.companyAddress)
        cy.get(`[data-test="client-company-vat"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.vat)
        cy.get(`[data-test="client-company-reg"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.reg)
        cy.get(`[data-test="client-company-iban"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.iban)
        cy.get(`[data-test="client-company-swift"]`)
            .clear()
            .type(NEW_CLIENT_DETAILS.swift)
    ...
    it('can edit existing client', () => {
        ...
        cy.get(`[data-test="client-email"]`)
            .clear()
            .type(`u_${NEW_CLIENT_DETAILS.email}`)
        cy.get(`[data-test="client-name"]`)
            .clear()
            .type(`updated ${NEW_CLIENT_DETAILS.name}`)
        cy.get(`[data-test="client-company-name"]`)
            .clear()
        ...
        cy.get(`[data-test="client-company-vat"]`)
            .clear()
            .type(`updated ${NEW_CLIENT_DETAILS.vat}`)
        cy.get(`[data-test="client-company-reg"]`)
            .clear()
            .type(`updated ${NEW_CLIENT_DETAILS.reg}`)
        cy.get(`[data-test="client-company-iban"]`)
            .clear()
            .type(`updated ${NEW_CLIENT_DETAILS.iban}`)
        cy.get(`[data-test="client-company-swift"]`)
            .clear()
        ...
        ).contains(`updated ${NEW_CLIENT_DETAILS.name}`)
        cy.get(
            `[data-test*="client-row"]:first [data-test="client-companyName"]`,
        ).contains(`updated ${NEW_CLIENT_DETAILS.companyName}`)
    })
})
export {}
